...
const parsed: GeneratedFiles = JSON.parse(promptReponse.code);
export default function PromptInput() {
  const [prompt, setPrompt] = useState<string>("");
  // const [generatedFiles, setGeneratedFiles] = useState<FileItem[]>([]);
  const [generatedFiles, setGeneratedFiles] = useState<FileItem[]>(parsed.files);
          ...
          <div className="generated-files">
            {generatedFiles.map((file) => (
              ...
              className="generated-files-block"
                key={file.filename}
              >
                <div className="generated-files-block-text">{file.filename}</div>
                <CopyBlock
                  text={file.content}
